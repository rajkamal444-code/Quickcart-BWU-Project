        ...
        <div className="flex-1">
          <div className="flex items-center justify-between mb-8 border-b border-gray-500/30 pb-6">
            <p className="text-2xl md:text-3xl text-gray-500">
              Your <span className="font-medium text-primary-600">Cart</span>
            </p>
                    ...
                    <tr key={itemId}>
                      <td className="flex items-center gap-4 py-4 md:px-4 px-1">
                        <div>
                          ...
                          <button
                            className="md:hidden text-xs text-primary-600 mt-1"
          ...
          <button onClick={()=> router.push('/all-products')} className="group flex items-center mt-6 gap-2 text-primary-600">
            <Image
